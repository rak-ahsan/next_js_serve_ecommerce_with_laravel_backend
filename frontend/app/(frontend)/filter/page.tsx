...
const FilterPage: React.FC<Props> = ({
  setFilterValues,
  setPriceValues,
  isChecked,
}) => {
  ...
  const value = ["rakib", "karim", "pabuni", "serabuni"];

  const price = ["1000", "5000", "7000", "15000"];

  const color = ["red", "blue", "yellow", "purple"];
  ...
  return (
    <div
      className="lg:h-screen overflow-y-scroll"
      style={{
        scrollbarWidth: "thin",
    ...
    >
      <div className="mt-4 mb-2 lg:w-72 ">
        ...
        />
        <p className="mt-3">৳ {newValue.join(" - ৳ ")}</p>
      </div>
